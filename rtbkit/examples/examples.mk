...
#------------------------------------------------------------------------------#
# My own augmentor based on redis NoSQL database 
$(eval $(call library,augmentor_redis_ex,augmentor_redis_ex.cc,augmentor_base rtb bid_request agent_configuration))
$(eval $(call program,augmentor_redis_ex_runner,augmentor_redis_ex boost_program_options))
#------------------------------------------------------------------------------#
...
#------------------------------------------------------------------------------#
# My own agents for triplelift, bidswitch exchanges and combined agent
$(eval $(call program,triplelift_agent_ex,bidding_agent rtb_router boost_program_options services))
$(eval $(call program,bidswitch_agent_ex,bidding_agent rtb_router boost_program_options services))
$(eval $(call program,combined_exchange_agent_ex,bidding_agent rtb_router boost_program_options services))
#------------------------------------------------------------------------------#

RTBKIT_INTEGRATION_TEST_LINK := \
	rtb_router bidding_agent integration_test_utils monitor monitor_service augmentor_ex augmentor_redis_ex adserver_connector mock_bid_request mock_adserver
