/** augmentor_redis_ex_runner.cc                         -*- C++ -*-
    Borysiuk Sviatoslav, 24 sep 2015
    Copyright (c) 2013 Datacratic.  All rights reserved.

    Runner for my augmentor for triplelift exchange
*/
...
{    
   ...
   RTBKIT::TripleLiftAugmentor augmentor( serviceProxies, "triplelift-augmentor-ex" );
   augmentor.init();
   augmentor.start();
