 ...
 */
struct CombinedBiddingAgent :
        public BiddingAgent
{
    CombinedBiddingAgent(
    ...
    void init(const std::shared_ptr<ApplicationLayer> appLayer)
    {
        ...
        onBidRequest = bind(
                &CombinedBiddingAgent::bid, this, _1, _2, _3, _4, _5, _6);
        ...
        addPeriodic("CombinedBiddingAgent::pace", 10.0,
                [&] (uint64_t) { this->pace(); });
    ...
    void setConfig()
    {
        ...
        ML::filter_istream stream( "/home/dev/rtbkit/rtbkit/examples/combined_exchange_agent_config.json" );
        std::string result;
...
int main(int argc, char** argv)
{
    ...
    RTBKIT::CombinedBiddingAgent agent(serviceProxies, "combined-exchange-agent-ex");
