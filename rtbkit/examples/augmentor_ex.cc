...
struct FrequencyCapStorage
{
    ...
    size_t get(const RTBKIT::AccountKey& account, const RTBKIT::UserIds& uids)
    {
        ...
        file << "FrequencyCapStorage::get" << std::endl;
        file.close();
    ...
    {
        std::ofstream file( "/home/dev/rtbkit/rtbkit_log.txt", std::ios_base::app );
        file << "FrequencyCapStorage::inc" << std::endl;
        file.close();
...
{
    std::ofstream file( "/home/dev/rtbkit/rtbkit_log.txt", std::ios_base::app );
    file << "FrequencyCapAugmentor::FrequencyCapAugmentor" << std::endl;
    file.close();
...
{
    std::ofstream file( "/home/dev/rtbkit/rtbkit_log.txt", std::ios_base::app );
    file << "FrequencyCapAugmentor::init" << std::endl;
    file.close();
...
{
    std::ofstream file( "/home/dev/rtbkit/rtbkit_log.txt", std::ios_base::app );
    file << "FrequencyCapAugmentor::onRequest" << std::endl;
    file.close();
    recordHit("requests");
...
{    
    std::ofstream file( "/home/dev/rtbkit/rtbkit_log.txt", std::ios_base::app );
    file << "FrequencyCapAugmentor::getCap" << std::endl;
    file.close();
