...
template<>
struct DefaultDescription<OpenRTB::NativeAssetTitle>
    : public StructureDescription<OpenRTB::NativeAssetTitle> {
    DefaultDescription();
};

template<>
struct DefaultDescription<OpenRTB::NativeAssetImage>
    : public StructureDescription<OpenRTB::NativeAssetImage> {
    DefaultDescription();
};

template<>
struct DefaultDescription<OpenRTB::NativeAssetVideo>
    : public StructureDescription<OpenRTB::NativeAssetVideo> {
    DefaultDescription();
};

template<>
struct DefaultDescription<OpenRTB::NativeAssetData>
    : public StructureDescription<OpenRTB::NativeAssetData> {
    DefaultDescription();
};
