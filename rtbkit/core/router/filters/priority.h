...
struct Priority
{
    ...
    static constexpr unsigned NativePreFilter      = 0x1500;
    static constexpr unsigned NativeLayoutFilter   = 0x1600;
    ...
    static constexpr unsigned NativeCompareFilter  = 0xF050;
